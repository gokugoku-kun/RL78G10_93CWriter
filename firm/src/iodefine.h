...
/*              RL78\Devicefile\DR5F10Y47.DVF -o=D:\Users\user\Documents\dev */
/*              elop\02_RL78G10\RL78G10\iodefine.h -f                         */
/* Date       : 2020/02/23                                                    */
...
#define ADM2         (*(volatile __near UBYTE  *)0x10)
#define ADM2_bit     (*(volatile __near __bitf_T *)0x10)
#define ADTYP        (((volatile __near __bitf_T *)0x10)->no0)
#define ADTES        (*(volatile __near UBYTE  *)0x13)
#define PU0          (*(volatile __near UBYTE  *)0x30)
#define PU0_bit      (*(volatile __near __bitf_T *)0x30)
#define PU4          (*(volatile __near UBYTE  *)0x34)
#define PU4_bit      (*(volatile __near __bitf_T *)0x34)
#define PU12         (*(volatile __near UBYTE  *)0x3C)
#define PU12_bit     (*(volatile __near __bitf_T *)0x3C)
#define POM0         (*(volatile __near UBYTE  *)0x50)
#define POM0_bit     (*(volatile __near __bitf_T *)0x50)
#define PMC0         (*(volatile __near UBYTE  *)0x60)
#define PMC0_bit     (*(volatile __near __bitf_T *)0x60)
#define NFEN0        (*(volatile __near UBYTE  *)0x70)
#define NFEN0_bit    (*(volatile __near __bitf_T *)0x70)
#define NFEN1        (*(volatile __near UBYTE  *)0x71)
#define NFEN1_bit    (*(volatile __near __bitf_T *)0x71)
#define ISC          (*(volatile __near UBYTE  *)0x73)
#define ISC_bit      (*(volatile __near __bitf_T *)0x73)
#define PIOR         (*(volatile __near UBYTE  *)0x77)
#define HOCODIV      (*(volatile __near UBYTE  *)0xA8)
#define PER0         (*(volatile __near UBYTE  *)0xF0)
...
#define OSMC         (*(volatile __near UBYTE  *)0xF3)
#define BCDADJ       (*(volatile __near UBYTE  *)0xFE)
#define SSR00        (*(volatile __near UBYTE  *)0x100)
#define SSR01        (*(volatile __near UBYTE  *)0x102)
#define SIR00        (*(volatile __near UBYTE  *)0x108)
#define SIR01        (*(volatile __near UBYTE  *)0x10A)
#define SMR00L       (*(volatile __near UBYTE  *)0x110)
#define SMR00H       (*(volatile __near UBYTE  *)0x111)
#define SMR01L       (*(volatile __near UBYTE  *)0x112)
#define SMR01H       (*(volatile __near UBYTE  *)0x113)
#define SCR00L       (*(volatile __near UBYTE  *)0x118)
#define SCR00H       (*(volatile __near UBYTE  *)0x119)
#define SCR01L       (*(volatile __near UBYTE  *)0x11A)
#define SCR01H       (*(volatile __near UBYTE  *)0x11B)
#define SE0          (*(volatile __near UBYTE  *)0x120)
#define SE0_bit      (*(volatile __near __bitf_T *)0x120)
#define SS0          (*(volatile __near UBYTE  *)0x122)
#define SS0_bit      (*(volatile __near __bitf_T *)0x122)
#define ST0          (*(volatile __near UBYTE  *)0x124)
#define ST0_bit      (*(volatile __near __bitf_T *)0x124)
#define SPS0         (*(volatile __near UBYTE  *)0x126)
#define SO0          (*(volatile __near UBYTE  *)0x128)
#define CKO0         (*(volatile __near UBYTE  *)0x129)
#define SOE0         (*(volatile __near UBYTE  *)0x12A)
#define SOE0_bit     (*(volatile __near __bitf_T *)0x12A)
#define SOL0         (*(volatile __near UBYTE  *)0x134)
#define TCR00L       (*(volatile __near UBYTE  *)0x180)
#define TCR00H       (*(volatile __near UBYTE  *)0x181)
#define TCR01L       (*(volatile __near UBYTE  *)0x182)
#define TCR01H       (*(volatile __near UBYTE  *)0x183)
#define TCR02L       (*(volatile __near UBYTE  *)0x184)
#define TCR02H       (*(volatile __near UBYTE  *)0x185)
#define TCR03L       (*(volatile __near UBYTE  *)0x186)
#define TCR03H       (*(volatile __near UBYTE  *)0x187)
#define TMR00L       (*(volatile __near UBYTE  *)0x190)
#define TMR00H       (*(volatile __near UBYTE  *)0x191)
#define TMR01L       (*(volatile __near UBYTE  *)0x192)
#define TMR01H       (*(volatile __near UBYTE  *)0x193)
#define TMR02L       (*(volatile __near UBYTE  *)0x194)
#define TMR02H       (*(volatile __near UBYTE  *)0x195)
#define TMR03L       (*(volatile __near UBYTE  *)0x196)
#define TMR03H       (*(volatile __near UBYTE  *)0x197)
#define TSR00        (*(volatile __near UBYTE  *)0x1A0)
#define TSR01        (*(volatile __near UBYTE  *)0x1A2)
#define TSR02        (*(volatile __near UBYTE  *)0x1A4)
#define TSR03        (*(volatile __near UBYTE  *)0x1A6)
#define TE0          (*(volatile __near UBYTE  *)0x1B0)
#define TE0_bit      (*(volatile __near __bitf_T *)0x1B0)
#define TEH0         (*(volatile __near UBYTE  *)0x1B1)
#define TEH0_bit     (*(volatile __near __bitf_T *)0x1B1)
#define TS0          (*(volatile __near UBYTE  *)0x1B2)
#define TS0_bit      (*(volatile __near __bitf_T *)0x1B2)
#define TSH0         (*(volatile __near UBYTE  *)0x1B3)
#define TSH0_bit     (*(volatile __near __bitf_T *)0x1B3)
#define TT0          (*(volatile __near UBYTE  *)0x1B4)
#define TT0_bit      (*(volatile __near __bitf_T *)0x1B4)
#define TTH0         (*(volatile __near UBYTE  *)0x1B5)
#define TTH0_bit     (*(volatile __near __bitf_T *)0x1B5)
#define TPS0         (*(volatile __near UBYTE  *)0x1B6)
#define TO0          (*(volatile __near UBYTE  *)0x1B8)
#define TOE0         (*(volatile __near UBYTE  *)0x1BA)
#define TOE0_bit     (*(volatile __near __bitf_T *)0x1BA)
#define TOL0         (*(volatile __near UBYTE  *)0x1BC)
#define TOM0         (*(volatile __near UBYTE  *)0x1BE)
#define IICCTL00     (*(volatile __near UBYTE  *)0x230)
...
#define IICCTL01     (*(volatile __near UBYTE  *)0x231)
...
#define IICWL0       (*(volatile __near UBYTE  *)0x232)
#define IICWH0       (*(volatile __near UBYTE  *)0x233)
#define SVA0         (*(volatile __near UBYTE  *)0x234)
#define P0           (*(volatile __near UBYTE  *)0xFF00)
#define P0_bit       (*(volatile __near __bitf_T *)0xFF00)
#define P4           (*(volatile __near UBYTE  *)0xFF04)
#define P4_bit       (*(volatile __near __bitf_T *)0xFF04)
#define P12          (*(volatile __near UBYTE  *)0xFF0C)
#define P12_bit      (*(volatile __near __bitf_T *)0xFF0C)
#define P13          (*(volatile __near UBYTE  *)0xFF0D)
#define P13_bit      (*(volatile __near __bitf_T *)0xFF0D)
#define SDR00L       (*(volatile __near UBYTE  *)0xFF10)
#define SIO00        (*(volatile __near UBYTE  *)0xFF10)
#define TXD0         (*(volatile __near UBYTE  *)0xFF10)
#define SDR00H       (*(volatile __near UBYTE  *)0xFF11)
#define RXD0         (*(volatile __near UBYTE  *)0xFF12)
#define SDR01L       (*(volatile __near UBYTE  *)0xFF12)
#define SIO01        (*(volatile __near UBYTE  *)0xFF12)
#define SDR01H       (*(volatile __near UBYTE  *)0xFF13)
#define TDR00L       (*(volatile __near UBYTE  *)0xFF18)
#define TDR00H       (*(volatile __near UBYTE  *)0xFF19)
#define TDR01L       (*(volatile __near UBYTE  *)0xFF1A)
#define TDR01H       (*(volatile __near UBYTE  *)0xFF1B)
#define ADCRL        (*(volatile __near UBYTE  *)0xFF1E)
#define ADCRH        (*(volatile __near UBYTE  *)0xFF1F)
#define PM0          (*(volatile __near UBYTE  *)0xFF20)
#define PM0_bit      (*(volatile __near __bitf_T *)0xFF20)
#define PM4          (*(volatile __near UBYTE  *)0xFF24)
#define PM4_bit      (*(volatile __near __bitf_T *)0xFF24)
#define ADM0         (*(volatile __near UBYTE  *)0xFF30)
...
#define ADS          (*(volatile __near UBYTE  *)0xFF31)
#define ADS_bit      (*(volatile __near __bitf_T *)0xFF31)
#define KRCTL        (*(volatile __near UBYTE  *)0xFF34)
#define KRCTL_bit    (*(volatile __near __bitf_T *)0xFF34)
#define KRF          (*(volatile __near UBYTE  *)0xFF35)
#define KRM0         (*(volatile __near UBYTE  *)0xFF37)
#define KRM0_bit     (*(volatile __near __bitf_T *)0xFF37)
#define EGP0         (*(volatile __near UBYTE  *)0xFF38)
#define EGP0_bit     (*(volatile __near __bitf_T *)0xFF38)
#define EGN0         (*(volatile __near UBYTE  *)0xFF39)
#define EGN0_bit     (*(volatile __near __bitf_T *)0xFF39)
#define IICA0        (*(volatile __near UBYTE  *)0xFF50)
#define IICS0        (*(volatile __near UBYTE  *)0xFF51)
...
#define IICF0        (*(volatile __near UBYTE  *)0xFF52)
...
#define COMPMDR      (*(volatile __near UBYTE  *)0xFF60)
...
#define COMPFIR      (*(volatile __near UBYTE  *)0xFF61)
#define COMPFIR_bit  (*(volatile __near __bitf_T *)0xFF61)
#define COMPOCR      (*(volatile __near UBYTE  *)0xFF62)
...
#define TDR02L       (*(volatile __near UBYTE  *)0xFF64)
#define TDR02H       (*(volatile __near UBYTE  *)0xFF65)
#define TDR03L       (*(volatile __near UBYTE  *)0xFF66)
#define TDR03H       (*(volatile __near UBYTE  *)0xFF67)
#define ITMCL        (*(volatile __near UBYTE  *)0xFF90)
#define ITMCH        (*(volatile __near UBYTE  *)0xFF91)
#define CMC          (*(volatile __near UBYTE  *)0xFFA0)
#define CSC          (*(volatile __near UBYTE  *)0xFFA1)
...
#define OSTC         (*(volatile __near UBYTE  *)0xFFA2)
#define OSTC_bit     (*(volatile __near __bitf_T *)0xFFA2)
#define OSTS         (*(volatile __near UBYTE  *)0xFFA3)
#define CKC          (*(volatile __near UBYTE  *)0xFFA4)
...
#define CKS0         (*(volatile __near UBYTE  *)0xFFA5)
#define CKS0_bit     (*(volatile __near __bitf_T *)0xFFA5)
#define PCLOE0       (((volatile __near __bitf_T *)0xFFA5)->no7)
#define RESF         (*(volatile __near UBYTE  *)0xFFA8)
#define WDTE         (*(volatile __near UBYTE  *)0xFFAB)
#define IF0L         (*(volatile __near UBYTE  *)0xFFE0)
...
#define IF0H         (*(volatile __near UBYTE  *)0xFFE1)
...
#define IF1L         (*(volatile __near UBYTE  *)0xFFE2)
...
#define MK0L         (*(volatile __near UBYTE  *)0xFFE4)
...
#define MK0H         (*(volatile __near UBYTE  *)0xFFE5)
...
#define MK1L         (*(volatile __near UBYTE  *)0xFFE6)
...
#define PR00L        (*(volatile __near UBYTE  *)0xFFE8)
...
#define PR00H        (*(volatile __near UBYTE  *)0xFFE9)
...
#define PR01L        (*(volatile __near UBYTE  *)0xFFEA)
...
#define PR10L        (*(volatile __near UBYTE  *)0xFFEC)
...
#define PR10H        (*(volatile __near UBYTE  *)0xFFED)
...
#define PR11L        (*(volatile __near UBYTE  *)0xFFEE)
...
#define PMC          (*(volatile __near UBYTE  *)0xFFFE)
